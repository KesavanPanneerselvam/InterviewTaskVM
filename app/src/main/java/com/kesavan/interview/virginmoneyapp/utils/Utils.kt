...
fun colorsList(): ArrayList<ColorName> {
    ...
    colorList.add(ColorName("Grey", 0x80, 0x80, 0x80))
    ...
    colorList.add(ColorName("MintGreen", 0x55, 0x6B, 0x2F))
...
fun ImageView.loadImagefromUrl(url: String) {
    Picasso.get().load(url).placeholder( R.drawable.ic_image_loading ).into(this);
}
private val formatter = SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS")
private val displayFormatter = SimpleDateFormat("dd-MMM-yyyy hh:mm a")
fun String.parseDate():String {
     return displayFormatter.format(formatter.parse(this))
}